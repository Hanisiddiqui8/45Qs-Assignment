...
let current_users = ["Usman", "Alara", "Sarah", "Muhammad", "Eric"]

//Array of New Users
let new_users = ["Hamza", "Saad", "Hira", "Usman", "Eric"]

//Loop through the new_users for usernames availability
new_users.forEach(new_one_user =>{
    //Making a condition for username that already exists and save in "our_condition" variable
